<template>
  <div v-if="currentInvoice" class="invoice-view container">
    <router-link class="nav-link flex" :to="{ name: 'Home' }">
      <img src="@/assets/icon-arrow-left.svg" alt="" class=""> Go Back
    </router-link>
    ...
    <div class="header flex">
      ...
      <div class="right flex">
        ...
        <button v-if="currentInvoice.invoiceDraft || currentInvoice.invoicePaid" @click="updateStatusToPending(currentInvoice.docId)" class="green">Mark as Pending</button>
      </div>
    </div>
